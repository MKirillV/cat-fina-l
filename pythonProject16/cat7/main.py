...
while True:
    ...
    if keys[pygame.K_DOWN] and y<630-h:             #кнопка вниз
        y += speed1
    if keys[pygame.K_UP] and y>0:             #кнопка в верх
        y -= speed1
    ...
    if keys[pygame.K_s] and y1<630-h:             #кнопка вниз
        y1 += speed2
    if keys[pygame.K_w] and y1>0:             #кнопка в верх
        y1 -= speed2
    ...
    if x1_bullet<x1+20 and x1_bullet>x1-20 and y1_bullet<y1+20 and y1_bullet>y1-20 :
        while True:
            pass
